...
from utils.extractors import SpacyExtractor
...
if __name__ == '__main__':
    # Initialize Spacy on startup (checks for model install and loads into memory)
    print("[Startup] Checking and loading Spacy model...")
    PECSCore._spacy_instance = SpacyExtractor()

    port = int(os.environ.get("PORT", 5000))
    print(f"Starting PECS Server on http://0.0.0.0:{port}")
